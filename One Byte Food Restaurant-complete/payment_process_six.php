...
<head>
    ...
    <link rel="stylesheet" href="payment_process_six.css">
    <style>
        .error-message {
            color: red;
            font-size: 14px;
    ...
    <div class="payment-container">
        ...
        if(isset($_POST['payment_method']) && isset($_POST['selected_tables']) && isset($_POST['date']) && isset($_POST['time']) && isset($_POST['user_name']) && isset($_POST['user_email'])) {
            ...
            foreach ($selected_tables as $table_id) {
                $sql_booking = "INSERT INTO booked_tables_six (table_number, booking_date, booking_time, user_name, user_email) VALUES (?, ?, ?, ?, ?)";
                ...
                $sql_update_availability = "UPDATE tables_six SET Availability = 'sold-out' WHERE TableID = ?";
    ...
    <script>    
        function showSuccessMessage() {
            ...
            setTimeout(function() {
                ...
                window.location.href = "6table.php"; // Redirect to 2table.php after 2 seconds
