...
$sql_availability = "SELECT TableID, TableName, Availability FROM tables_four";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insert reservation details into the booked_tables_four table
...
<body>
    ...
    function updateFormFields() {
        ...
        document.getElementById('seats').value = numTables * 4; // Assuming each table has 4 seats

        // Update the total amount displayed
        var totalAmount = numTables * 400; // Assuming each table costs $400
    ...
    function buyTable() {
        ...
        // Pass selected tables, date, time, user_name, and user_email as URL parameters to payment_four.php
